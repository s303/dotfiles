...
# WTF?
#
# This is used only to speed up shell startup.
# Original `conda init fish` creates an initialization block in `config.fish`
# that runs `eval /Users/s303/opt/miniconda3/bin/conda "shell.fish" "hook" $argv`
# which run about a second and just generates the content below. 
#
#
#
#
